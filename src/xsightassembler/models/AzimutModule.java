...
@Entity
@Table(name = "azimut_module")
public class AzimutModule {
    ...
    @Column(name = "board", length = 64, nullable = false, unique = true)
    ...
    @Column(name = "top", length = 64, nullable = false, unique = true)
    private String top;
